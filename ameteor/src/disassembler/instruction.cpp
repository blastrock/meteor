...
void Instruction::ParseArm(uint32_t offset, uint32_t code)
{
  ...
  else if (((code >> 25) & 0x7) == 0x5)
  {
    ...
    {
      m_operator = "BLX";
      m_args.AddArgument(ArgImmediate(
          offset + 8 +
  ...
  else if (((code >> 26) & 0x3) == 0x1)
  {
    ...
    if (code & (0x1 << 25)) // register offset
    {
      ...
      case 0: // Logical Shift Left
        m_args.AddArgument(ArgRelative(
            Rn,
            ArgShift(
                ArgRegister(Rm),
                ArgImmediate((code >> 7) & 0x1F),
                SHIFT_LSL,
                false),
            code & (0x1 << 24),
            code & (0x1 << 23),
      ...
      case 1: // Logical Shift Right
        if (code & (0x1F << 7))
          ...
          m_args.AddArgument(ArgRelative(
              Rn,
              ArgShift(ArgRegister(Rm), ArgImmediate(32), SHIFT_LSR, false),
              code & (0x1 << 24),
              code & (0x1 << 23),
              code & (0x1 << 21)));
        break;
      case 2: // Arithmetic Shift Right
        if (code & (0x1F << 7))
          ...
          m_args.AddArgument(ArgRelative(
              Rn,
              ArgShift(ArgRegister(Rm), ArgImmediate(32), SHIFT_ASR, false),
              code & (0x1 << 24),
              code & (0x1 << 23),
              code & (0x1 << 21)));
        break;
      case 3: // ROtate Right
        if (code & (0x1F << 7))
          ...
          m_args.AddArgument(ArgRelative(
              Rn,
              ArgShift(ArgRegister(Rm), ArgImmediate(1), SHIFT_RRX, false),
              code & (0x1 << 24),
              code & (0x1 << 23),
              code & (0x1 << 21)));
        break;
  ...
  else if (((code >> 25) & 0x7) == 0x0)
  {
    if ((code & 0x0FC000F0) == 0x00000090 ||
        (code & 0x0F8000F0) == 0x00800090 || (code & 0x0F900090) == 0x01000080)
    {
    ...
    else if ((code & (0x1 << 7)) && (code & (0x1 << 4)))
    {
      ...
      else
      {
        ...
        m_operator = Instructions[((code >> 18) & 0x4) | ((code >> 5) & 0x3)];
    ...
    else if (((code >> 23) & 0x3) == 0x2)
    {
      if (!((code >> 20) & 0x1))
      {
        if (code & (0x1 << 21))
        {
          ...
          m_args.AddArgument(ArgPsr(code & (0x1 << 22), (code >> 16) & 0xF));

          if (code & (0x1 << 25)) // immediate
          {
            m_args.AddArgument(
                ArgUImmediate(ROR(code & 0xFF, (code >> 8) & 0xF)));
          }
          else
          {
            m_args.AddArgument(ArgRegister(Rm));
  ...
  if (code & (0x1 << 25)) // Immediate operand 2
  {
    /*if (code & (0xF << 8))
            m_args.AddArgument(ArgShift(ArgImmediate(code & 0xFF),
                                    ArgImmediate(((code >> 8) & 0xF) << 1),
    SHIFT_ROR, false)); else m_args.AddArgument(ArgImmediate(code & 0xFF));*/
    m_args.AddArgument(ArgUImmediate(ROR(code & 0xFF, (code >> 7) & 0x1E)));
  }
  else
  {
    switch ((code >> 5) & 0x3)
    ...
    case 0:                  // Logical Shift Left
      ...
      {
        m_args.AddArgument(
            ArgShift(ArgRegister(Rm), ArgRegister(Rs), SHIFT_LSL, false));
      }
      else // Shift by immediate
      {
        if (code & (0x1F << 7))
          m_args.AddArgument(ArgShift(
              ArgRegister(Rm),
              ArgImmediate((code >> 7) & 0x1F),
              SHIFT_LSL,
              false));
    ...
    case 1:                  // Logical Shift Right
      ...
      {
        m_args.AddArgument(
            ArgShift(ArgRegister(Rm), ArgRegister(Rs), SHIFT_LSR, false));
      }
      else // Shift by immediate
      {
        if (code & (0x1F << 7))
    ...
    case 2:                  // Arithmetic Shift Right
      ...
      {
        m_args.AddArgument(
            ArgShift(ArgRegister(Rm), ArgRegister(Rs), SHIFT_ASR, false));
      }
      else // Shift by immediate
      {
        if (code & (0x1F << 7))
    ...
    case 3:                  // ROtate Right
      ...
      {
        m_args.AddArgument(
            ArgShift(ArgRegister(Rm), ArgRegister(Rs), SHIFT_ROR, false));
      }
      else // Shift by immediate
      {
        if (code & (0x1F << 7))
...
void Instruction::ParseThumb(uint32_t offset, uint16_t code)
{
  ...
  else if ((code >> 11) == 0x9) // 01001
  {
    ...
    m_args.AddArgument(
        ArgRelative(15, ArgImmediate(Imm << 2), true, true, false));
  }
  else if ((code >> 12) == 0x8) // 1000
  {
    ...
    m_args.AddArgument(ArgRegister(Rd));
    m_args.AddArgument(
        ArgRelative(Rs, ArgImmediate(Off << 1), true, true, false));
  }
  ...
  else if ((code >> 13) == 0x3) // 011
  {
    ...
    m_args.AddArgument(ArgRegister(Rd));
    if (code & (0x1 << 12))
      m_args.AddArgument(ArgRelative(Rs, ArgImmediate(Off), true, true, false));
    else
      m_args.AddArgument(
          ArgRelative(Rs, ArgImmediate(Off << 2), true, true, false));
  }
  ...
  else if ((code >> 11) == 0x1C) // 11100
  {
    ...
    if (code & (0x1 << 10))
      m_args.AddArgument(ArgUImmediate(
          offset + 4 + ((int32_t)(((code & 0x3FF) << 1) | 0xFFFFF800))));
    else
  ...
  else if ((code >> 12) == 0xD) // 1101
  {
    ...
    else // 1101
    {
      ...
      m_args.AddArgument(
          ArgUImmediate(offset + 4 + (((int32_t)(int8_t)Imm) << 1)));
    }
  }
