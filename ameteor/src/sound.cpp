...
Sound::Sound()
  : m_speaker(
        IO.GetRef16(Io::SOUND1CNT_L),
        IO.GetRef16(Io::SOUND1CNT_H),
        IO.GetRef16(Io::SOUND1CNT_X),
        IO.GetRef16(Io::SOUND2CNT_L),
        IO.GetRef16(Io::SOUND2CNT_H),
        IO.GetRef16(Io::SOUND4CNT_L),
        IO.GetRef16(Io::SOUND4CNT_H),
        IO.GetRef16(Io::SOUNDCNT_L),
        IO.GetRef16(Io::SOUNDCNT_H),
        IO.GetRef16(Io::SOUNDCNT_X),
        IO.GetRef16(Io::SOUNDBIAS))
  , m_fATimer(0)
  , m_fBTimer(0)
{
}
