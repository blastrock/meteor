...
public:
  ...
  connection_func(FuncPtr ptr) : _func(ptr)
  {
  }
...
public:
  ...
  connection_func1(FuncPtr ptr) : _func(ptr)
  {
  }
...
public:
  ...
  connection_meth(TypeObj& obj, FuncPtr ptr) : _obj(obj), _meth(ptr)
  {
  }
...
public:
  ...
  connection_meth1(TypeObj& obj, FuncPtr ptr) : _obj(obj), _meth(ptr)
  {
  }
...
private:
  ...
  slot(const connection_base<Tret>& conn) : _conn(conn.clone())
  {
  }
...
private:
  ...
  slot1(const Connection& conn) : _conn(conn.clone())
  {
  }
  ...
  friend slot1<Tret2, Targ02> mem_fun(Tobj2& obj, Tret2 (Tobj2::*fun)(Targ02));
};
...
private:
  ...
  connection(List* list, Iterator iter) : _list(list), _iter(iter)
  {
  }
